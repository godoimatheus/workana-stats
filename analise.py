...
skills_jobs = df_skills.groupby(
    'skills')['_id'].count().sort_values(ascending=False)
...
higher_paid_skills = df_skills.groupby(
    'skills')['media'].mean().sort_values(ascending=False)
...
higher_paid_countries = df.groupby(
    'pais')['media'].mean().sort_values(ascending=False)
...
average_fixed_countries = fixed_payment_skills.groupby(
    'pais')['media'].mean().sort_values(ascending=False)
...
average_hourly_countries = hourly_country.groupby(
    'pais')['media'].mean().sort_values(ascending=False)
...
fixed_skills = df_skills[['skills', 'media']
                         ].loc[df_skills['forma_pag'] == 'Fixed']
average_fixed_skills = fixed_skills.groupby(
    'skills')['media'].mean().sort_values(ascending=False)
...
hourly_skills = df_skills[['skills', 'media']
                          ].loc[df_skills['forma_pag'] == 'Hourly']
average_hourly_skills = hourly_skills.groupby(
    'skills')['media'].mean().sort_values(ascending=False)
...
# anos com mais vagas
year_jobs = df.groupby(df['data_vaga'].dt.strftime('%Y'))[
    '_id'].count().sort_values(ascending=False)
...
month_jobs = df.groupby(df['data_vaga'].dt.strftime(
    '%Y-%m'))['_id'].count().sort_values(ascending=False)
...
# vagas dia
day_jobs = df.groupby(df['data_vaga'].dt.strftime(
    '%Y-%m-%d'))['_id'].count().sort_values(ascending=False)
...
average_fixed_countries100 = fixed_payment_skills.groupby(
    'pais')['media'].agg(['mean', 'count'])
average_fixed_countries100 = average_fixed_countries100.loc[average_fixed_countries100['count'] >= 100].sort_values(
